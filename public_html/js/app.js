...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Index_vue__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Create_vue__ = __webpack_require__(45);
...
(function ($) {
    $(function () {
        ...
        function addSkill() {
            if ($('#inputSkill').val() != '') {
                $('#skills').append($('<li>').append('<span>' + $('#inputSkill').val() + '</span>' + '<input type="hidden" name="skills[]" value="' + $('#inputSkill').val() + '">' + '<span class="buttonSkill">×</span>'));
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_pagination_2__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_pagination_2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_pagination_2__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        Pagination: __WEBPACK_IMPORTED_MODULE_1_vue_pagination_2___default.a
    },
    mounted: function mounted() {
        this.getProjects();
        this.getTotal();
    ...
    methods: {
        swapComponent: function swapComponent(component, dataVar) {
        ...
        getProjects: function getProjects() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/admin/api/projects/' + this.limit + '/' + this.offset + this.getLink()).then(function (response) {
                return _this.projects = response;
            });
        },
        ...
        getTotal: function getTotal() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(link).then(function (response) {
                return _this2.count = response;
            });
        },
...
module.exports = {
  ...
  computed: {
    ...
    Theme: function Theme() {
      ...
      var themes = {
        bootstrap3: __webpack_require__(41),
        bootstrap4: __webpack_require__(42),
        bulma: __webpack_require__(43)
      };
...
var render = function() {
  ...
  return _c("div", [
          ...
          on: {
            input: [
              function($event) {
                ...
                _vm.filterType = $event.target.value
              },
              function($event) {
                _vm.getProjects(1)
              }
    ...
    _c("table", { staticClass: "table table-bordered" }, [
      ...
      _c(
        "tbody",
        _vm._l(_vm.projects.data, function(project, key, index) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(project.id))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(project.title))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(project.organization))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(project.start))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(project.end))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(project.role))]),
            _vm._v(" "),
      ...
      _c("tfoot", [
        _c("tr", [
          _c(
            ...
            [
              _c("pagination", {
                attrs: { records: _vm.count.data, "per-page": 10 },
                on: {
...
var staticRenderFns = [
      ...
      _c("div", { staticClass: "col-lg-12 margin-tb" }, [
        _c("div", { staticClass: "pull-right" }, [
          _c(
            ...
            {
              staticClass: "btn btn-primary",
              attrs: { href: "/admin/projects-vue/create" }
            },
            [_vm._v("Add Project")]
          )
        ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("strong", [_vm._v("Title")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("strong", [_vm._v("Organization")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("strong", [_vm._v("Type")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        create: function create() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/admin/api/project/create', {
                title: this.title,
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.descrription,
                expression: "descrription"
              }
            ],
            staticClass: "form-control",
            domProps: { value: _vm.descrription },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.descrription = $event.target.value
              }
            }
          })
        ]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            project: {},
            linkPdf: '/admin/project/generate-pdf/' + this.id
        };
    },
    mounted: function mounted() {
        this.getProject();
  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-lg-12 margin-tb" }, [
        _c("div", { staticClass: "pull-right" }, [
          _c(
            "a",
            { staticClass: "btn btn-primary", attrs: { href: _vm.linkPdf } },
            [_vm._v("Generate PDF")]
          )
        ])
      ])
    ...
    _c("div", { staticClass: "col-xs-12 col-sm-12 col-md-12" }, [
      ...
      _c("div", [
        _c("label", [_vm._v("Organization:")]),
        _vm._v(
          "\n            " + _vm._s(_vm.project.organization) + "\n        "
        )
      ]),
      _vm._v(" "),
      _c("div", [
        _c("label", [_vm._v("Start:")]),
        _vm._v("\n            " + _vm._s(_vm.project.start) + "\n        ")
      ]),
      _vm._v(" "),
      _c("div", [
        _c("label", [_vm._v("End:")]),
        _vm._v("\n            " + _vm._s(_vm.project.end) + "\n        ")
      ]),
      _vm._v(" "),
      _c("div", [
        _c("label", [_vm._v("Role:")]),
        _vm._v("\n            " + _vm._s(_vm.project.role) + "\n        ")
      ]),
      _vm._v(" "),
      _c("div", [
        _c("label", [_vm._v("Link:")]),
      ...
      _c("div", [
        _c("label", [_vm._v("Description:")]),
        _vm._v(
          "\n            " + _vm._s(_vm.project.descrription) + "\n        "
        )
      ])
    ])
  ])
